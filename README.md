<div align="center">
  <a href="https://github.com/klzbw/momo-music" target="blank">
    <img src="buildAssets/icons/icon.png" alt="Logo" width="156" height="156">
  </a>
  <h2  style="font-weight: 600">momo-music</h2>
  <p>多数据源桌面音乐播放器</p>
</div>

[![LocalMusic][localMusic-screenShot]](https://github.com/klzbw/momo-music)
...
- 账号登录问题可以从 [wiki - 账号登录](https://github.com/klzbw/momo-music/wiki/%E8%B4%A6%E5%8F%B7%E7%99%BB%E9%99%86) 里查看解决方法。此外，[wiki](https://github.com/klzbw/momo-music/wiki/) 里也包含了linux插件、逐字歌词、流媒体等方面的简要说明。
...
[![Stargazers over time](https://starchart.cc/klzbw/momo-music.svg?variant=adaptive)](https://starchart.cc/klzbw/momo-music)
