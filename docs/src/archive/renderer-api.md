...
在引入插件系统之前，momo-music 只支持网易云音乐一个在线源。`src/renderer/api/` 封装了对 [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) 的前端调用，是当时唯一的数据获取方式。
